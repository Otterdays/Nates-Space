...
[AMENDED 2026-03-24]: **`js/admin-panel.js`** + **`admin.html`** — owner-only Firestore moderation UI (same Firebase compat CDNs as `index.html`); not part of the public feed bundle.
